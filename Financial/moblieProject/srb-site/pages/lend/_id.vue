<template>
  ...
  <div class="item-detail wrap">
    ...
    <!-- 还款计划 -->
    <div class="item-detail-body clearfix mrt30 ui-tab" v-if="userType == 2">
      <div class="ui-tab-nav hd">
        <ul>
          <li class="nav_li active">
...
export default {
  ...
  async asyncData({ $axios, params }) {
    ...
    return {
      ...
      lendItemList: responseLendItemList.data.list,//投资人信息
  ...
  methods: {
    ...
    commitInvest() {
      ...
      // return
      if (Number(this.invest.investAmount) === 0 ||
