  ...
  <div class="personal-main">
    <div class="personal-money">
      ...
      <div class="personal-moneylist" style="margin-top: 40px;">
        ...
        <ul>
          <li v-for="transFlow in transFlowList" :key="transFlow.id" style="width:100%">
            ...
            <span :title="transFlow.memo" class="pmain-title1 pmain-height" style="width: 500px; overflow: hidden;">
              {{ transFlow.memo }}
            </span>
          </li>
        </ul>
