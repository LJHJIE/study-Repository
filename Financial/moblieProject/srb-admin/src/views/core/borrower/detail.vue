  ...
  <div class="app-container">
    ...
    <el-form label-width="170px" v-if="borrower.status === '认证中'">
      ...
      <el-form-item v-if="approvalForm.status == 2" label="身份证信息是否正确">
        ...
        <span v-if="approvalForm.isIdCardOk == true" style="color: indianred">（正确即可获得30积分）</span>
      </el-form-item>
      ...
      <el-form-item v-if="approvalForm.status == 2" label="车辆信息是否正确">
        ...
        <span v-if="approvalForm.isCarOk == true" style="color: indianred">（正确即可获得60积分）</span>
      </el-form-item>
      ...
      <el-form-item v-if="approvalForm.status == 2" label="房产信息是否正确">
        ...
        <span v-if="approvalForm.isHouseOk == true" style="color: indianred">（正确即可获得100积分）</span>
      </el-form-item>
