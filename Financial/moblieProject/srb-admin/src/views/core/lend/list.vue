<template>
  <div class="app-container">
    ...
    <el-table :data="list" stripe>
      ...
      <el-table-column prop="lendNo" label="标的编号" width="200" />
      ...
      <el-table-column prop="lendStartDate" label="开始日期" width="100" />
      <el-table-column prop="lendEndDate" label="结束日期" width="100" />
      <el-table-column prop="param.returnMethod" label="还款方式" width="130" />
