...
export const constantRoutes = [
  ...
  },
  {
    ...
    // false （默认值）:当且仗当父节点下只有一个子节点时，不显示父节点
    // true:任何时候都显示父节点和子节点
    alwaysShow: true,
    //定义子路由
    children: [
      {
        ...
        meta: { title: '积分等级列表', icon: 'el-icon-trophy' } //meta：定义导航的标题
      },
      {
        path: 'create',
        name: 'coreIntegralGradeCreate',
        component: () => import('@/views/core/integral-grade/form'),
        meta: { title: '新增积分等级', icon: 'el-icon-folder-add' } //icon：导航图标
      },
      {
        path: 'edit/:id',
        name: 'coreIntegralGradeEdit',
        component: () => import('@/views/core/integral-grade/form'),
        meta: { title: '编辑积分等级' }, //icon：导航图标
        hidden: true //是否显示在左导航列表。
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        meta: { title: '数据字典', icon: 'el-icon-document' }
      }
    ]
  },
  {
    ...
    name: 'Example',
    meta: { title: '列子', icon: 'el-icon-s-help' },
    children: [
      {
        path: 'table',
        name: 'Table',
...

  {
    path: '/form',
    component: Layout,
    meta: { title: '一级标题', icon: 'el-icon-position' },
    // false （默认值）:当且仗当父节点下只有一个子节点时，不显示父节点
    // true:任何时候都显示父节点和子节点
    alwaysShow: true,
    children: [
