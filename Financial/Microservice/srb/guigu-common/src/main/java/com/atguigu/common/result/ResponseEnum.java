...
public enum ResponseEnum {
    ...
    USER_INFO_BORROWER_ERROR(305, "借款人无法进行投资"),
    LEND_INVEST_ERROR(306, "当前状态无法投标"),
    LEND_FULL_SCALE_ERROR(307, "已满标，无法投标"),
    NOT_SUFFICIENT_FUNDS_ERROR(308, "余额不足"),
